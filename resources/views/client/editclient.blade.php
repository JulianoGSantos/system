        ...
        <div>
            ...
            <div class="grid grid-cols-2">
                <div class="mt-2">
                    ...
                    <input type="text" name="name" id="iname" style="height: 35px" class="rounded-md ring-2" value="{{$client->name}}">
                </div>
                <div class="mt-2">
                    <label for="icpf" class="font-semibold text-sm">CPF</label><br>
                    <input type="text" name="cpf" id="icpf" style="height: 35px" class="rounded-md ring-2" value="{{$client->cpf}}">
                </div>
            </div>
                <div class="mt-2">
                    <label for="iemail" class="font-semibold text-sm">E-mail</label><br>
                    <input type="text" name="email" id="iemail" style="height: 35px" class="rounded-md ring-2" value="{{$client->email}}">
                </div>
            <div class="mt-12 font-semibold text-sm">Endereço</div>
            <div class="grid grid-cols-2">
                    <div class="mt-2">
                        <label for="istreet" class="font-semibold text-sm">Rua</label><br>
                        <input type="text" name="street" id="istreet" style="height: 35px" class="rounded-md ring-2" value="{{$client->street}}"><br>
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" name="city" id="icity" style="height: 35px" class="rounded-md ring-2" value="{{$client->city}}"><br>
                    </div>
                    <div class="mt-2">
                        <label for="istate" class="font-semibold text-sm">Estado</label><br>
                        <input type="text" name="state" id="istate" style="height: 35px" class="rounded-md ring-2" value="{{$client->state}}"><br>
                    </div>
                    <div class="mt-2">
                        <label for="icep" class="font-semibold text-sm">CEP</label><br>
                        <input type="text" name="cep" id="icep" style="height: 35px" class="rounded-md ring-2" value="{{$client->cpf}}"><br>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="cellphone" id="icellphone" style="height: 35px" class="rounded-md ring-2" value="{{$client->cellphone}}"><br>
                    </div>
                    <div>
                        <label for="icellphone2" class="font-semibold text-sm">Celular2</label><br>
                        <input type="text" name="cellphone2" id="icellphone2" style="height: 35px" class="rounded-md ring-2" value="{{$client->cellphone2}}"><br>
                    </div>
                </div>
            </div>
            <div class="mt-4 mb-5">
